...
//    }
    ...
    public static void saveStateAsSingleChannelImage(String fileName, FloatPointer inputPtr, int pos, int frameSize, int channels) {
        byte[] imgData = new byte[frameSize*channels];
...
//                for (int c = 0; c < 84; c++) {
////                    byte val = mat.data().get(r*84 + c);
//                    byte val = (byte)(floatMat.data().get(r*84 + c)*255);
//                    imgData[index] = val;
//                    index ++;
//                }
//            }
//        }
        for (int i = 0; i < imgData.length; i++) {
            byte val = (byte)(inputPtr.get(i)*255f);
            imgData[i] = val;
        }
    ...
    public static void saveMatAsImage(String fileName, opencv_core.Mat imgMat) {
        ScreenConverter converter = new ScreenConverter();
